		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Books Master Detail",
									"targetURL": "#BooksMasterDetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BooksMasterDetail-display": {
								"semanticObject": "BooksMasterDetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.booksui5masterdetail",
									"url": sap.ui.require.toUrl("demo/booksui5masterdetail")
								}
							}
						}
					}
