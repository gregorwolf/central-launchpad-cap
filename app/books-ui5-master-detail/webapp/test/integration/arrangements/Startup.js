sap.ui.define([
	"sap/ui/test/Opa5",
	"demo/booksui5masterdetail/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("demo.booksui5masterdetail.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "demo.booksui5masterdetail",
					async: true
				},
				hash: oOptions.hash,
