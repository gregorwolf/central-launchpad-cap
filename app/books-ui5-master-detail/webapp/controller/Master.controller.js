sap.ui.define([
	...
	return BaseController.extend("demo.booksui5masterdetail.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				stock : function(oContext) {
					var iNumber = oContext.getProperty('stock'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "demo.booksui5masterdetail.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("stock", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("stock", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
